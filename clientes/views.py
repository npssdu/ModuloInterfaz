...
Usa oracledb en modo THICK para Oracle 11g XE
"""
...
# Ruta al Oracle Client (Oracle XE 11g)
ORACLE_CLIENT_PATH = r"C:\oraclexe\app\oracle\product\11.2.0\server\bin"

# Inicializar modo THICK para Oracle 11g (solo una vez)
try:
    oracledb.init_oracle_client(lib_dir=ORACLE_CLIENT_PATH)
except Exception as e:
    print(f"Nota: {e}")  # Ya inicializado o error
...
def conectar_bd():
    ...
    try:
        ...
        conexion = oracledb.connect(user=ORACLE_USER, password=ORACLE_PASSWORD, dsn=dsn)
        return conexion
    except Exception as e:
